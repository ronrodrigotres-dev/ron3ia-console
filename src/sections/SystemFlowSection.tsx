  ...
  return (
    <section ref={sectionRef} className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* Progress Indicator */}
                    {isActive && (
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-neon-cyan/20 rounded-b-xl overflow-hidden">
        ...
        {/* Active Step Details */}
        <div className={`mt-12 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="glass-panel-strong rounded-xl p-6">
            ...
            <div className="flex items-center gap-6">
              {(() => {
                ...
                return (
                  <div className="w-16 h-16 rounded-xl bg-neon-cyan/10 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-white/60">{flowSteps[activeStep].description}</p>
              </div>
