...
import { Radar, DataStream } from '@/components/effects';
    ...
    <section ref={sectionRef} className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="w-[600px] h-[600px] border border-neon-cyan/10 rounded-full animate-pulse" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div 
          className={`
            relative glass-panel-strong rounded-2xl p-8 md:p-12
            transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}
          `}
        >
          {/* Corner Decorations */}
          <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-neon-cyan/30 rounded-tl-2xl" />
          <div className="absolute top-0 right-0 w-20 h-20 border-t-2 border-r-2 border-neon-cyan/30 rounded-tr-2xl" />
          <div className="absolute bottom-0 left-0 w-20 h-20 border-b-2 border-l-2 border-neon-cyan/30 rounded-bl-2xl" />
          <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-neon-cyan/30 rounded-br-2xl" />
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 rounded-full bg-neon-cyan/10 flex items-center justify-center mx-auto mb-2 animate-pulse">
        ...
        <div 
          ...
          `}
        >
          <p className="text-white/40 text-sm mb-4">Confían en RON3IA</p>
          <div className="flex flex-wrap justify-center gap-8">
            <div className="text-white/30 font-mono text-lg">TECHCORP</div>
            <div className="text-white/30 font-mono text-lg">INNOVALABS</div>
            <div className="text-white/30 font-mono text-lg">DIGITALX</div>
            <div className="text-white/30 font-mono text-lg">FUTURECO</div>
          </div>
        </div>
      </div>
    </section>
