      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-white/40 text-xs">Métodos convencionales</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-neon-cyan text-xs">Inteligencia Autónoma</p>
              </div>
            </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left p-3 text-white/50 text-xs font-mono uppercase tracking-wider">
                    Característica
                  </th>
                  <th className="text-center p-3 text-white/50 text-xs font-mono uppercase tracking-wider">
                    Tradicional
                  </th>
                  <th className="text-center p-3 text-neon-cyan text-xs font-mono uppercase tracking-wider">
                    RON3IA
                  </th>
                </tr>
              </thead>
        ...
        >
          <div className="glass-card rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-neon-cyan mb-1">10x</div>
            <div className="text-[10px] text-white/50 uppercase">Más rápido</div>
          </div>
          <div className="glass-card rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-neon-cyan mb-1">99.9%</div>
            <div className="text-[10px] text-white/50 uppercase">Precisión</div>
          </div>
          <div className="glass-card rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-neon-cyan mb-1">60%</div>
            <div className="text-[10px] text-white/50 uppercase">Menor costo</div>
          </div>
          <div className="glass-card rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-neon-cyan mb-1">24/7</div>
            <div className="text-[10px] text-white/50 uppercase">Disponible</div>
          </div>
        </div>
      </div>
    </section>
